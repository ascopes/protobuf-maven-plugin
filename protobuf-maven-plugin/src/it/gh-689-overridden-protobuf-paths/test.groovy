...
["child-with-absolute-path", "child-with-relative-path"].forEach { childModule ->
  Path generatedSourcesDir = baseDirectory
      .resolve(childModule)
      .resolve("target/generated-sources/protobuf")
  Path classesDir = baseDirectory
      .resolve(childModule)
